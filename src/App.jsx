        ...
        <footer className="mt-16 border-t border-slate-200 dark:border-white/[0.06] transition-colors duration-300">
          ...
          <div className="w-[90%] max-w-[1200px] mx-auto py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
              {/* Brand */}
              <div>
                <img src={logoNew} alt="True Force Security" className="h-12 w-auto mb-4 brightness-110 contrast-110" />
              ...
              {/* Quick Links */}
              <div>
                <h4 className="text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white mb-4">{t('nav.home')} & {t('nav.services')}</h4>
                <ul className="space-y-2">
                  {[
                    ...
                    <li key={link.label}>
                      <Link to={link.path} className="text-sm text-slate-500 dark:text-slate-400 hover:text-blue-500 dark:hover:text-blue-400 transition-colors duration-300">
                        {link.label}
                      </Link>
                    </li>
                  ))}
              ...
              {/* Contact */}
              <div>
                <h4 className="text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white mb-4">{t('nav.contact')}</h4>
